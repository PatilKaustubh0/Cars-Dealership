...
def initiate():
    car_make_data = [
        ...
        {"name":"Tata", "description":"Great cars. Japanese technology"},
    ]
    ...
    car_model_data = [
      ...
      {"name":"Manza", "type":"Sedan", "year": 2023, "car_make":car_make_instances[5]},
      {"name":"Harrier", "type":"SUV", "year": 2023, "car_make":car_make_instances[5]},
      {"name":"Safari", "type":"SUV", "year": 2023, "car_make":car_make_instances[5]},
